...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} id="hero" className="relative min-h-screen grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-16 pt-28 lg:pt-36 pb-12 lg:pb-20 px-[5vw] max-w-[1280px] mx-auto overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="hero-eyebrow mb-6">
          <div className="flex gap-4 mb-6">
            <span className="inline-flex items-center justify-center min-w-[110px] h-10 text-[0.8rem] font-bold tracking-widest uppercase text-lime border-[1.5px] border-lime rounded-lg px-5 transition-all hover:bg-lime hover:text-white hover:-translate-y-0.5 hover:shadow-lime cursor-default">
              {t("hero.mirik")}
            </span>
            <span className="inline-flex items-center justify-center min-w-[110px] h-10 text-[0.8rem] font-bold tracking-widest uppercase text-lime border-[1.5px] border-lime rounded-lg px-5 transition-all hover:bg-lime hover:text-white hover:-translate-y-0.5 hover:shadow-lime cursor-default">
              {t("hero.plassey")}
        ...
        <p className="hero-tagline text-base sm:text-lg lg:text-xl font-light text-text-mid dark:text-white/80 leading-relaxed mb-10 max-w-xl">
          {t("hero.tagline")}
        </p>

        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          <a href="#about" className="hero-btn group relative inline-flex items-center justify-center px-9 py-3.5 rounded-full bg-lime text-white font-semibold text-sm tracking-wide shadow-lime transition-all hover:bg-olive hover:shadow-lg-custom hover:-translate-y-0.5 hover:pr-12">
            {t("hero.explore")}
      ...
      <div className="hero-visual hidden md:flex relative z-10 justify-center h-[540px] py-4 overflow-hidden">
        <div className="grid grid-cols-[1.2fr_1fr] gap-3 w-full h-full">
          <div className="hero-col-left flex flex-col gap-3">
            <div className="flex-1 overflow-hidden rounded-2xl relative group">
              <img src="/hero2.jpeg" alt="Rural youth learning" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
            <div className="flex-1 overflow-hidden rounded-2xl relative group">
              <img src="/hero1.jpg" alt="Youth community" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
          </div>
          <div className="hero-col-right flex flex-col gap-3">
            <div className="flex-1 h-full overflow-hidden rounded-2xl relative group">
              <img src="/hero3.jpg" alt="Aspiring student" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
          </div>
        </div>
      </div>

      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 hidden lg:flex flex-col items-center gap-2 text-[0.7rem] tracking-widest uppercase text-text-muted">
        <span>{t("hero.scroll")}</span>
        <div className="w-px h-10 bg-gradient-to-b from-lime to-transparent animate-float" />
      </div>
    </section>
  );
}
